...
const NAV = [
  ...
  { href: '/order-history', label: 'Order History', icon: ClipboardList,   s: 'ORDERS',       roles: ['owner','counter','viewer'] as UserRole[] },
  { href: '/delivery',      label: 'Delivery',      icon: Truck,           s: 'ORDERS',       roles: ['owner','delivery','viewer'] as UserRole[] },
  { href: '/inventory',     label: 'Inventory',     icon: Package,         s: 'OPERATIONS',   roles: ['owner','viewer'] as UserRole[] },
  ...
  { href: '/settings',      label: 'Settings',      icon: Settings,        s: 'SYSTEM',       roles: ['owner','viewer'] as UserRole[] },
]
